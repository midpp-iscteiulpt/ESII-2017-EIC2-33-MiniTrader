...
public class MicroTraderLog {

	public static void write(int id, String stock, int units, Double price) {

		try {
			File inputFile = new File("MiniTraderTransactionLogUS.xml");
			...
			StreamResult result = new StreamResult(new FileOutputStream("MiniTraderTransactionLogUS.xml"));
